...
public class CampanhaController {
    ...
    public CampanhaResponseDTO CadastroCampanha(@RequestBody @Valid CampanhaRequestDTO campanhaRequestDTO) {
        return campanhaServico.CadastroCampanha(campanhaRequestDTO);
    }
}
